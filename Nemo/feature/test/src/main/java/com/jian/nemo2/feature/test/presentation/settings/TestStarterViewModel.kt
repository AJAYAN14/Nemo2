...
import com.jian.nemo2.feature.test.domain.manager.TestSessionManager
...
import com.jian.nemo2.feature.test.presentation.settings.model.TestNavigationEvent
...
class TestStarterViewModel @Inject constructor(
    ...
    private val generateAdaptiveTestUseCase: com.jian.nemo2.feature.test.domain.usecase.GenerateAdaptiveTestUseCase,

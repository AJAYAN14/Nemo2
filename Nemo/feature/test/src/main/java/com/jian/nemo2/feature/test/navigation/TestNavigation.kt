package com.jian.nemo2.feature.test.navigation
...
import com.jian.nemo2.feature.test.TestScreen
...
fun NavGraphBuilder.testScreen(navController: NavHostController) {
    ...
    composable(
        ...
        com.jian.nemo2.feature.test.presentation.settings.TestSettingsScreen(
            testModeId = testModeId,
            onBack = { navController.popBackStack() },
            onNavigate = { event ->
                when(event) {
                    is com.jian.nemo2.feature.test.presentation.settings.model.TestNavigationEvent.NavigateToTest -> {
                    ...
                    is com.jian.nemo2.feature.test.presentation.settings.model.TestNavigationEvent.NavigateToTypingTest -> {

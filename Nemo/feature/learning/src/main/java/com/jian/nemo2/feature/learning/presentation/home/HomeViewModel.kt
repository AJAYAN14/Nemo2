package com.jian.nemo2.feature.learning.presentation.home

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.jian.nemo2.core.data.repository.NotificationRepositoryImpl
import com.jian.nemo2.core.domain.model.AppNotification
import com.jian.nemo2.core.domain.model.User
import com.jian.nemo2.core.domain.repository.ConfigRepository
import com.jian.nemo2.core.domain.usecase.auth.GetUserFlowUseCase
import com.jian.nemo2.feature.learning.presentation.LearningMode
import com.jian.nemo2.feature.learning.R
...
class HomeViewModel @Inject constructor(
    private val getLearningStatsUseCase: com.jian.nemo2.core.domain.usecase.statistics.GetLearningStatsUseCase,
    ...
    private val syncMessageBus: com.jian.nemo2.core.common.util.SyncMessageBus
) : ViewModel() {
    ...
    fun onStartLearningClick(onReady: () -> Unit, onNotReady: () -> Unit) {
        if (!_uiState.value.isDataReady) {
            viewModelScope.launch {
                syncMessageBus.emit(com.jian.nemo2.core.common.util.SyncEvent.Error("词库资料正在导入中，请稍候..."))
            }
            onNotReady()
            return
        }

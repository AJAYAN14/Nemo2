package com.jian.nemo2.feature.library.presentation.detail
...
import com.jian.nemo2.core.designsystem.theme.*
    ...
    Box(
        ...
        if (showReportDialog) {
            ...
            ContentReportDialog(
                ...
                onConfirm = { type, desc ->
                    currentWordId?.let { viewModel.reportContentError(it, type, desc) }
                }
            )
        }
    }
    ...
    PremiumDetailCard(isDark = isDark) {
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                com.jian.nemo2.core.ui.component.text.FuriganaText(
                    text = sentence,

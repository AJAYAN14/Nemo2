...
data class SettingsUiState(
    ...
    val availableVoices: List<com.jian.nemo2.core.domain.model.TtsVoice> = emptyList(),
    ...
    val user: com.jian.nemo2.core.domain.model.User? = null,
...
sealed interface SettingsEvent {
    ...
    object ClearStatusMessage : SettingsEvent
    object RestoreDefaultAdvancedLearningSettings : SettingsEvent

package com.jian.nemo2.feature.statistics.presentation.dashboard
...
import com.jian.nemo2.core.domain.usecase.grammar.GetSkippedGrammarsUseCase
import com.jian.nemo2.core.domain.usecase.grammar.RecoverLeechGrammarUseCase
import com.jian.nemo2.core.domain.usecase.word.GetSkippedWordsUseCase
import com.jian.nemo2.core.domain.usecase.word.RecoverLeechWordUseCase
...
sealed class LeechEvent {
    ...
    data class RecoverWord(val id: Long) : LeechEvent()
    data class RecoverGrammar(val id: Long) : LeechEvent()
...
class LeechManagementViewModel @Inject constructor(
    ...
    private fun recoverWord(id: Long) {
        viewModelScope.launch {
    ...
    private fun recoverGrammar(id: Long) {
        viewModelScope.launch {

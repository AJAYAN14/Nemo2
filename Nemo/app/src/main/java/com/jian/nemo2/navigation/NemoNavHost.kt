package com.jian.nemo2.navigation
...
import com.jian.nemo2.core.ui.navigation.NavDestination
import com.jian.nemo2.core.ui.component.splash.SplashScreen
import com.jian.nemo2.feature.user.AuthViewModel
import com.jian.nemo2.core.ui.animation.NemoNavigationAnimations


import com.jian.nemo2.feature.learning.presentation.home.HomeScreen


import com.jian.nemo2.feature.settings.SettingsScreen
import com.jian.nemo2.feature.settings.TtsSettingsScreen
import com.jian.nemo2.feature.settings.ThemeSettingsScreen

import com.jian.nemo2.feature.learning.presentation.LearningScreen
import com.jian.nemo2.feature.learning.presentation.LearningMode
import com.jian.nemo2.feature.learning.presentation.kana.KanaChartScreen
import com.jian.nemo2.feature.learning.presentation.review.ReviewScreen
import com.jian.nemo2.feature.collection.navigation.favoritesScreen
import com.jian.nemo2.feature.collection.navigation.mistakesScreen
import com.jian.nemo2.feature.collection.navigation.wrongWordsScreen
import com.jian.nemo2.feature.collection.navigation.wrongGrammarsScreen
import com.jian.nemo2.feature.collection.navigation.WRONG_WORDS_ROUTE
import com.jian.nemo2.feature.collection.navigation.WRONG_GRAMMARS_ROUTE
import com.jian.nemo2.feature.collection.navigation.favoriteWordsScreen
import com.jian.nemo2.feature.collection.navigation.favoriteGrammarsScreen
import com.jian.nemo2.feature.collection.navigation.favoriteQuestionsScreen
import com.jian.nemo2.feature.collection.navigation.FAVORITE_WORDS_ROUTE
import com.jian.nemo2.feature.collection.navigation.FAVORITE_QUESTIONS_ROUTE
import com.jian.nemo2.feature.statistics.navigation.statisticsScreen
import com.jian.nemo2.feature.statistics.navigation.historicalStatisticsScreen
import com.jian.nemo2.feature.statistics.navigation.leechManagementScreen
import com.jian.nemo2.feature.test.navigation.testScreen
import com.jian.nemo2.feature.test.navigation.navigateToTestSettings
import com.jian.nemo2.feature.user.navigation.userGraph
import com.jian.nemo2.feature.user.navigation.ROUTE_LOGIN
...
fun NemoNavHost(
    ...
    NavHost(
        ...
        composable(
            ...
            com.jian.nemo2.feature.statistics.presentation.dashboard.ProgressDashboardScreen(
        ...
        composable(
            ...
            com.jian.nemo2.feature.test.presentation.dashboard.TestDashboardScreen(
                onNavigateBack = { navController.popBackStack() },
        ...
        composable(
            ...
            com.jian.nemo2.feature.library.presentation.LibraryScreen()
        }
        ...
        composable(NavDestination.ADVANCED_LEARNING) {
            com.jian.nemo2.feature.settings.AdvancedLearningSettingsScreen(
                onNavigateBack = { navController.popBackStack() }
            )
        }
        ...
        composable(NavDestination.PART_OF_SPEECH) {
            com.jian.nemo2.feature.library.presentation.partofspeech.PartOfSpeechScreen(
                onNavigateBack = { navController.popBackStack() },
        ...
        composable(
            ...
            com.jian.nemo2.feature.library.presentation.category.PosWordsScreen(
                onNavigateBack = { navController.popBackStack() }
            )
        }
        ...
        composable(
            ...
            com.jian.nemo2.feature.library.presentation.category.CategoryClassificationScreen(
                source = source,
                onNavigateBack = { navController.popBackStack() },
        ...
        composable(
            ...
            com.jian.nemo2.feature.learning.presentation.category.CategoryCardLearningScreen(
                category = category,
        ...
        composable(
            ...
            val category = backStackEntry.arguments?.getString("category") ?: ""
            val categoryTitle = backStackEntry.arguments?.getString("categoryTitle") ?: ""
            com.jian.nemo2.feature.library.presentation.category.CategoryWordsScreen(
                category = category,
                categoryTitle = categoryTitle,
                onNavigateBack = { navController.popBackStack() },
        ...
        composable("review_session") {
            com.jian.nemo2.feature.learning.presentation.review.ReviewSessionScreen(
                onNavigateBack = { navController.popBackStack() }
            )
        }
        ...
        composable(NavDestination.LEARNING_CALENDAR) {
            com.jian.nemo2.feature.statistics.calendar.LearningCalendarScreen(
                onNavigateBack = { navController.popBackStack() }
            )
        }
        ...
        composable(NavDestination.ACTIVITY_HEATMAP) {
            com.jian.nemo2.feature.statistics.ActivityHeatmapScreen(
                onBack = { navController.popBackStack() }
            )
        }
        ...
        composable(NavDestination.WORD_LIST) {
            com.jian.nemo2.feature.library.presentation.list.WordListScreen(
                navController = navController
            )
        }
        ...
        composable(NavDestination.GRAMMAR_LIST) {
            com.jian.nemo2.feature.library.presentation.list.GrammarListScreen(
                navController = navController
            )
        }
        ...
        composable(
            ...
            com.jian.nemo2.feature.library.presentation.detail.WordDetailScreen(
        ...
        composable(
            ...
            com.jian.nemo2.feature.library.presentation.detail.GrammarDetailScreen(
                onNavigateBack = { navController.navigateUp() }
            )
        }

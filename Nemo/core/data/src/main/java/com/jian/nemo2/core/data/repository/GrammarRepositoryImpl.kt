...
import com.jian.nemo2.core.data.mapper.GrammarMapper.toDomainModel
import com.jian.nemo2.core.data.mapper.GrammarMapper.toDomainModels
import com.jian.nemo2.core.data.mapper.GrammarMapper.toProgressEntity
...
class GrammarRepositoryImpl @Inject constructor(
    ...
    override fun getReviewForecast(startDate: Long, endDate: Long): Flow<List<com.jian.nemo2.core.domain.model.ReviewForecast>> {
        ...
        return grammarDao.getReviewForecast(startIso, endIso)
            .map { tuples ->
                tuples.map {
                    com.jian.nemo2.core.domain.model.ReviewForecast(date = DateTimeUtils.isoToEpochDay(it.date), grammarCount = it.count)
                }
            }
            .catch { e ->
                emit(emptyList())

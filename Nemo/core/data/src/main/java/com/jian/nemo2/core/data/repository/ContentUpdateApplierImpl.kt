...
import com.jian.nemo2.core.data.local.dao.GrammarExampleDao
import com.jian.nemo2.core.data.local.dao.GrammarUsageDao
...
import com.jian.nemo2.core.data.mapper.toGrammarEntity
import com.jian.nemo2.core.data.mapper.toUsageEntities
import com.jian.nemo2.core.data.mapper.toExampleEntities
        ...
        withContext(Dispatchers.IO) {
            try {
                ...
                database.withTransaction {
                    ...
                    val allExampleEntities = mutableListOf<com.jian.nemo2.core.data.local.entity.GrammarExampleEntity>()
                    var usageIdCursor = 0
                    grammars.forEach { dto ->

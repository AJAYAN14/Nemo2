...
import com.jian.nemo2.core.data.local.dao.GrammarWrongAnswerDao
import com.jian.nemo2.core.data.mapper.toDomainModel
import com.jian.nemo2.core.data.mapper.toEntity
import com.jian.nemo2.core.domain.model.GrammarWrongAnswer
...
class GrammarWrongAnswerRepositoryImpl @Inject constructor(
            ...
            .map { entities ->
                ...
                entities.map { entity ->
                    ...
                    val grammarDomain = grammarEntity?.let {
                        with(com.jian.nemo2.core.data.mapper.GrammarMapper) {
                            com.jian.nemo2.core.data.local.entity.relations.GrammarWithUsages(
                                grammar = it,
                                usages = emptyList(),
                                state = null
                            ).toDomainModel()
    ...
    override suspend fun getWrongAnswerByGrammarIdSync(grammarId: Long): GrammarWrongAnswer? = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.IO) {
        try {
    ...
    override fun getWrongAnswersByGrammarId(grammarId: Long): Flow<List<GrammarWrongAnswer>> {
    ...
    override suspend fun getAllWrongGrammarIds(): List<Long> = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.IO) {
        try {
    ...
    override suspend fun deleteByGrammarId(grammarId: Long): Result<Unit> = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.IO) {
        try {
            grammarWrongAnswerDao.markDeletedByGrammarId(grammarId, com.jian.nemo2.core.common.util.DateTimeUtils.getCurrentCompensatedMillis())

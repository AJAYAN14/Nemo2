...
import com.jian.nemo2.core.data.local.NemoDatabaseCallback
import com.jian.nemo2.core.data.local.dao.*
import com.jian.nemo2.core.data.local.migration.MIGRATION_2_3
import com.jian.nemo2.core.data.local.migration.MIGRATION_11_12
import com.jian.nemo2.core.data.local.migration.MIGRATION_12_13
import com.jian.nemo2.core.data.local.migration.MIGRATION_14_15
...
object DatabaseModule {
    ...
    @Provides
    @Singleton
    fun provideGrammarQuestionDao(database: NemoDatabase): GrammarQuestionDao = database.grammarQuestionDao()
}

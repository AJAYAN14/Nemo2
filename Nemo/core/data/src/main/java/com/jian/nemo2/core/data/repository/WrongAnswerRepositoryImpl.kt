...
import com.jian.nemo2.core.data.local.dao.WrongAnswerDao
import com.jian.nemo2.core.data.mapper.WordMapper.toDomainModel
import com.jian.nemo2.core.data.mapper.WrongAnswerMapper.toDomainModel
import com.jian.nemo2.core.data.mapper.WrongAnswerMapper.toEntity
...
class WrongAnswerRepositoryImpl @Inject constructor(
    ...
    override suspend fun deleteByWordId(wordId: Long): Result<Unit> = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.IO) {
        try {
            wrongAnswerDao.markDeletedByWordId(wordId, com.jian.nemo2.core.common.util.DateTimeUtils.getCurrentCompensatedMillis())

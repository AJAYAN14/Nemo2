package com.jian.nemo2.core.data.worker
    ...
    override suspend fun doWork(): Result = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            if (syncResult.success) {
                 ...
                 // syncMessageBus.tryEmit(com.jian.nemo2.core.common.util.SyncEvent.Success())
                 ...
                 // 发送全局失败通知 (包含具体原因)
                 syncMessageBus.tryEmit(com.jian.nemo2.core.common.util.SyncEvent.Error("同步失败: ${syncResult.message}"))
            ...
            // 发送全局异常通知
            syncMessageBus.tryEmit(com.jian.nemo2.core.common.util.SyncEvent.Error("同步异常: ${e.message ?: "未知错误"}"))

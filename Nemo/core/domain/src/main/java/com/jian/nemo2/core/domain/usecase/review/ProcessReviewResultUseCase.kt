package com.jian.nemo2.core.domain.usecase.review
...
class ProcessReviewResultUseCase @Inject constructor(
    ...
    private val reviewLogRepository: com.jian.nemo2.core.domain.repository.ReviewLogRepository, // [NEW]
    ...
    suspend fun processWord(word: Word, quality: Int) {
        ...
        try {
            reviewLogRepository.insertLog(
                com.jian.nemo2.core.domain.model.ReviewLog(
                    itemId = word.id,
                    itemType = "word",
                    reviewDate = com.jian.nemo2.core.common.util.DateTimeUtils.getCurrentCompensatedMillis(), // 精确时间戳
        ...
        try {
            reviewLogRepository.insertLog(
                com.jian.nemo2.core.domain.model.ReviewLog(
                    itemId = grammar.id,
                    itemType = "grammar",
                    reviewDate = com.jian.nemo2.core.common.util.DateTimeUtils.getCurrentCompensatedMillis(),
                    intervalDays = actualInterval,
                    rating = quality
                )
            )

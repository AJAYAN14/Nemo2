package com.jian.nemo2.core.domain.usecase.test
...
class SubmitTestResultUseCaseTest {
    ...
    fun `should save wrong answer with correct word id and user answer for multiple choice`() = runTest {
        ...
        coEvery { wrongAnswerRepository.insertWrongAnswer(capture(savedWrongAnswer)) } returns com.jian.nemo2.core.common.Result.Success(Unit)
